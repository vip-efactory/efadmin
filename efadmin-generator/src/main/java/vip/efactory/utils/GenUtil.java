...
public class GenUtil {
    ...
    public static List<String> getFrontTemplateNames() {
        ...
        templateNames.add("SQL"); // SQL权限菜单模板
        return templateNames;
    }
     ...
     */
    public static void generatorCode(List<ColumnInfo> columnInfos, GenConfig genConfig, TableInfo table) throws IOException {
        String tableName = (String) table.getTableName();
        String tableRemark = (String) table.getRemark();

        Map<String, Object> map = new HashMap();
        map.put("package", genConfig.getPack());
        map.put("moduleName", "efadmin-" + genConfig.getModuleName());
        map.put("author", genConfig.getAuthor());
        map.put("date", LocalDate.now().toString());
        map.put("tableName", tableName);
        map.put("tableRemark", tableRemark); // 表的注释
        ...
        // 生成前端代码
        map.put("moduleName", genConfig.getModuleName());  //覆盖变量,前端不需要efadmin-开头
    ...
    public static String getAdminFilePath(String templateName, GenConfig genConfig, String className) {
        String projectPath = System.getProperty("user.dir") + File.separator + "efadmin-" + genConfig.getModuleName();
    ...
    public static String getFrontFilePath(String templateName, GenConfig genConfig, String apiName) {
        ...
        // menu及权限sql生成路径
        String sqlPath = System.getProperty("user.dir") + File.separator + "db";
        ...
        if ("SQL".equals(templateName)) {
            return sqlPath + File.separator + apiName + ".sql";  //生成的sql路径
        }
        return null;
    }
