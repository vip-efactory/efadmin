...
public class LogServiceImpl extends BaseServiceImpl<Log, Long, LogRepository> implements LogService {
    ...
    public Object queryAll(LogQueryCriteria criteria, Pageable pageable) {
        Page<Log> page = br.findAll(((root, criteriaQuery, cb) -> QueryHelp.getPredicate(root, criteria, cb)), pageable);
    ...
    public Object findByErrDetail(Long id) {
        return Dict.create().set("exception", br.findExceptionById(id));
    }
}
